...
var Crawler = /** @class */ (function () {
    function Crawler(_url, analyzer) {
        this._url = _url;
    ...
    Crawler.prototype.writeFile = function (content) {
        fs_1.default.writeFileSync(this._resultFilePath, content);
    };
    // 异步请求，使用async和await
    Crawler.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRawHtml(this._url)];
                    case 1:
                        html = _a.sent();
                        fileContent = this.analyzer.analyze(html, this._resultFilePath);
                        // 写入json文件中
